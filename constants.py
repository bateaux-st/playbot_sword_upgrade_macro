...
_BOT = "@플레이봇"
CMD_GIFT = f"{_BOT} 선물받기"
CMD_PROFILE = f"{_BOT} 프로필"
CMD_ENHANCE = f"{_BOT} 강화"
CMD_ADVANCED_ENHANCE = f"{_BOT} 상급강화"
CMD_CHECK_IN = f"{_BOT} 출석체크"
CMD_BATTLE = f"{_BOT} 배틀"
CMD_SWAP = f"{_BOT} 교체"
CMD_FUSION = f"{_BOT} 합성"
CMD_SELL = f"{_BOT} 판매"
CMD_RANKING = f"{_BOT} 랭킹"
CMD_COLLECTION = f"{_BOT} 도감"
CMD_HELP = f"{_BOT} 도움말"
GAME_COMMANDS = (
    {
        "key": "gift",
